...
%%
% root = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\12.11.20\SF0020\trial1\';
% root = 'C:\Users\sydne\Documents\thermal_experiments\data\12.11.20\SF0020\trial1\';
% file = 'FLIR0103.csq';

%root = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\12.29.20\SF0049\trial1';
%file = 'FLIR0152.csq';
% root = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\3.9.21\SF0106\trial1';
%file = 'FLIR0192.csq';
root = 'C:\Users\sydne\Documents\thermal_experiments\data\3.9.21\SF0109\trial1';
file = 'FLIR0202.csq';
path = fullfile(root, file);

outfile = 'temp_data.csv';
% outroot = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\12.29.20\SF0049\trial1';
% outroot = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\1.3.21\SF0075\trial1';
outroot = 'G:\My Drive\Tuthill Lab Shared\Katie\thermal_experiments\data\snow_flies\3.9.21\SF0109\trial1';
outroot = 'D:\sydne\Documents\snow_flies\1.11.21\SF0084\trial1';
...
%    if (t > 5) && (median(intensity(end-4:end)) < 0.1) 
%        col = xpos(end);
%        row = ypos(end);
%    end 
    
%     if (t > 5)
%         if (abs(col - xpos(end)) > 70) || (abs(row - ypos(end)) > 70)
%             if mean(intensity(end-4:end)) < 0.3
%                 col = xpos(end);
%                 row = ypos(end);
%             end 
%         end
...
outpath = fullfile(outroot, 'temp_data.csv');
